...
import { HEX_AUDIENCE, HEX_CURSEMARKED, HEX_SEQUENCE } from '../../utilities/appsettings';
import { $random, $sleep, $throw } from '../../utilities/common';
import { $log_command_to_channel } from '../../utilities/logger';
...
export const execute = async i => {
    ...
    .on('collect', async response => votes.set(response.user.id, response.values[0]))
